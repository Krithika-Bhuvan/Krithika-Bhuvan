...
Krithika is a Health Data Scientist with over 15 years experience and combines her interdisciplinary skills in health data science, informatics and applied statistics to solve real-world healthcare challenges

Krithika employs machine learning, applied statistics, and systems biology techniques for in-depth analysis. Additionally, she applies her interdisciplinary skills to clean, analyze, interpret and visualize complex biomedical data. Her work also involves using cloud computing (Amazon and Google cloud) and high-performance computing (HPC) for analyzing large-scale data analysis of genomic data. 
...
* Book chapter: Bioinformatics in Mental Health: Deriving Knowledge from Molecular and Cellular Data (Chapter 11). [Bhuvaneswhar K et al.](https://www.springer.com/gp/book/9783030) (_**Springer** 2021**_)
